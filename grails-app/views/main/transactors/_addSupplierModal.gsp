<div id="addSupplier" class="ui modal">
  <div class="header" style="padding-top: 16px; padding-bottom: 13px;">
		<i class="circular teal user icon"
			style="margin-right: 10px;"></i>New Supplier</div>
  <div class="content">    
      <g:form id="saddform" class="ui form" controller="transactor" action="addSupplier">	
		...
		<div class="actions" style="float:right; margin-bottom:14px;">
			...
			<div class="ui right labeled icon cancel button" id="sCancelBtn" ><i class="cancel basic icon"></i>Cancel</div>
			<div class="ui right labeled icon button" id="sDoneBtn" style="display: none;" onclick="location.href = '/Moneytor/main/main?tab=suppliersTabLink';" ><i class="checkmark icon"></i>Done</div>
	 	</div>    	
    </g:form>
  </div>
</div>