		...
		<div class="inline fields">
			<div class="inline fields">
				<div class="three wide field">
					<label>Entries per page</label> <select class="ui dropdown"	id="payablesNumEntries">
		...
		<tbody>
			<g:each in="${payableList}" var="payable">
				<tr title="Last updated on ${payable.updated_on}">
					...
					<td>
						<button class="ui right labeled icon button teal" onClick="addPayment('${payable.id}','${supplierName}','${payable.amount}')">
