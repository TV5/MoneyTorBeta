<div class="ui bottom attached active tab segment"
	data-tab="payablesTab" style="padding-bottom: 50px">
	<div class="ui form ">
		<div class="inline fields">
			<div class="inline fields thirteen wide" style="float: left">
				...
				<div class="three wide field">
					<label>Start Date</label> <input type="text" id="" class="minP">
				</div>
				<div class="three wide field">
					<label>End Date</label> <input type="text" id="" class="maxP">
				</div>
		...
		<tbody>
			<g:each in="${payableList}" var="payable">
				<tr title="Last updated on ${payable.updated_on}">
					...
					<td><a href="#"
						onClick="editPayable($(this),'${payable.id}','${payable.or_no}','${payable.transactor_id}','${payable.amount}','${payable.transaction_date}')"><i
