		...
		<div class="inline fields">
			<div class="inline fields">
				<div class="three wide field">
					<label>Entries per page</label> <select class="ui dropdown"	id="receivablesNumEntries">
				...
				<div class="six wide field">
					<button id="addReceivableBtn" style="margin-left:auto; margin-right:0;" class="ui labeled icon button teal">
		...
		<tbody>
			<g:each in="${receivableList}" var="receivable">
				<tr title="Last updated on ${receivable.updated_on}">
					...
					<td>
						<g:formatDate format="MM/dd/yyyy" date="${receivable.transaction_date}"/>
					</td>
					<td class="dueDate">
					...
					<td>
						<button class="ui right labeled icon button teal" onClick="addPayment('${receivable.id}','${customerName}','${receivable.amount}')">
