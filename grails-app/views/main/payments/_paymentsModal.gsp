<div id="payments" class="ui modal small" style="padding-top: -50px !important;">
		...
		<g:formRemote name="subForm" url="[controller:'payment', action:'addPayment']" class="ui form">
			...
			<div class="inline fields">
				...
				<div class="four wide field">
					<button data-content="Overpayment is not allowed."
						class="ui labeled icon button teal pop" onclick="pymntAdded()">
						<i class="dollar basic icon"></i>Add Payment
					</button>
				</div>
			</div>
		</g:formRemote>
	...
	<div class="actions">
		<div onClick="confirmPay()"
			class="ui right labeled icon approve button">
